    ...
    <div className="min-h-screen bg-[#FAF8F5] text-[#1E2A4A]" style={sans}>
      ...
      <nav className="sticky top-0 z-40 bg-[#FAF8F5]/95 backdrop-blur-md border-b border-[#1E2A4A]/10">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 h-16">
          ...
          <h1 className="text-base font-semibold tracking-tight" style={serif}>Our Tutors</h1>
          <span className="text-xs text-[#1E2A4A]/40 uppercase tracking-widest">{tutors.length} tutors</span>
        </div>
      </nav>
